...
def qcbm_approx_probs(weights, num_wires):
    ...
    for i in range(num_samples):
        ...
        prob_dict[outcome] = prob_dict.get(outcome, 1)
...
if __name__ == "__main__":
    #Test the model
    print(f"num_wires: {num_wires}, num_shots: {num_shots}")

    weights = initialize_weights(7, 8)
    ...
    #Uses approximate QCBM probability from samples in the K-L Loss
